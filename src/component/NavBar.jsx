...
function NavBar() {
  ...
  return (
    <nav className="flex flex-row items-center justify-between w-screen h-[48px] p-5 py-8 border-[#DAD6D1] bg-[#EFEEEB] border sticky top-0 z-50">
      {/* Logo for my Name */}
      <a href="/" className="">
        <h1 className="hidden md:flex font-bold font-poppins text-2xl">
          Natthanat<span className=" text-[#12B379]">.</span>
        </h1>
        <h1 className="md:hidden font-bold font-poppins text-2xl">
        ...
        <DropdownMenu >
          ...
          <DropdownMenuContent className="mt-[12px] w-screen flex flex-col items-center justify-center gap-4 h-[200px] hover-">
        ...
        {/* button for lg desktop login, sign up */}
